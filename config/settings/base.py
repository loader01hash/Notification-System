"""
Base settings for the notification system.
"""
import os
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': config('CACHE_KEY_PREFIX', default='notification_system'),
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='krushnappanm@gmail.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='krushnappanm@gmail.com')
...
NOTIFICATION_CONFIG = {
    'TELEGRAM': {
        ...
        'DEFAULT_CHAT_ID': config('TELEGRAM_CHAT_ID', default=''),
        'TIMEOUT': config('NOTIFICATION_TIMEOUT', default=30, cast=int),
    },
    'EMAIL': {
        'TIMEOUT': config('NOTIFICATION_TIMEOUT', default=30, cast=int),
    },
    'RETRY': {
        'MAX_ATTEMPTS': config('MAX_RETRY_ATTEMPTS', default=3, cast=int),
        'DELAY': config('RETRY_DELAY', default=60, cast=int),
    }
}
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': config('LOG_FILE_PATH', default='logs/notification_system.log'),
            'formatter': 'verbose',
        },
    },
    'root': {
